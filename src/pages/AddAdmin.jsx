  ...
  return (
    ...
    <div className="md:grid  md:gap-6">
      ...
      <div className="mt-5 md:col-span-2 md:mt-0">
        <form onSubmit={handleAddAdmin} className="dark:bg-inherit dark:border-2 dark:border-blue-800 ">
          <div className="overflow-hidden shadow sm:rounded-md">
            <div className="bg-white px-4 py-5 sm:p-6 dark:bg-inherit dark:text-white">
              ...
              <div className="col-span-6 sm:col-span-2">
                ...
                <div className="col-span-6 sm:col-span-2">
                  <label htmlFor="aID" className="block text-sm font-medium text-gray-700 dark:text-white">
                    Admin ID
                  </label>
                    <input
                      type="text"
